...
const serialWriter = require("./handlers/serialProcessor");
...
function runEffect(effect, trigger) {
    ...
    case EffectTypeList.TEXT_TO_FILE:
        ...
        break;
    case EffectTypeList.TEXT_TO_SERIAL:
        serialWriter.run(effect, trigger);
        break;
    ...
    case EffectTypeList.UPDATE_BUTTON:
        if (effect != null && effect.control != null && effect.properties != null) {
            Interactive.updateButtonProperties(effect.control.controlId, effect.properties);
        }
        break;
